  ...
  return (
    <Card color="transparent" variant="gradient" className="w-full max-w-[25rem] p-8">
      ...
      >
        ...
        >
          <span className="font-gilroy font-light text-6xl leading-none tracking-wider text-white">$</span>500{" "}
      ...
      <CardBody className="p-0">
        <ul className="flex flex-col gap-4">
          <li className="flex items-center gap-4">
            ...
            <Typography className="font-gilroy font-bold text-white text-2xl leading-6 tracking-tighter">Up to 100.000 User Join</Typography>
          </li>
          <li className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon strokeWidth={2} className="h-3 w-3" />
            </span>
            <Typography className="font-gilroy font-bold text-white text-2xl leading-6 tracking-tighter">5.000+ Assets</Typography>
          </li>
          <li className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon strokeWidth={2} className="h-3 w-3" />
